...
final class WC_Gateway_CdlCheckout_Blocks extends AbstractPaymentMethodType {
    ...
    public function get_payment_method_script_handles() {
        ...
        $script_asset_path = plugins_url( '/assets/js/block/blocks.asset.php', CDL_CHECKOUT_MAIN_FILE );
        $script_asset      = file_exists( $script_asset_path )
            ? require $script_asset_path
            : array(
                'dependencies' => array(),
                'version'      => CDL_CHECKOUT_VERSION,
            );

        $script_url = plugins_url( '/assets/js/block/blocks.js', CDL_CHECKOUT_MAIN_FILE );
    ...
    public function get_payment_method_data() {
        ...
        return [
            ...
            'logo_url'         => array( $payment_gateways['cdl_checkout']->cdl_checkout_get_logo_url() ),
        ];
    }
